package com.mycompany.kafka.governance.data.protection.interceptors;

import com.mycompany.kafka.governance.data.protection.ProducerRuleViolation;
import com.mycompany.kafka.governance.data.protection.RuleViolation;
import com.mycompany.kafka.governance.data.protection.rules.FieldValidationRulesFactory;
import com.mycompany.kafka.governance.data.protection.util.ClientIdGenerator;
...
public class DataProtectionProducerInterceptor<K, V> implements ProducerInterceptor<K, V> {
    ...
    public DataProtectionProducerInterceptor() {
        this.rules = FieldValidationRulesFactory.create();
    }
