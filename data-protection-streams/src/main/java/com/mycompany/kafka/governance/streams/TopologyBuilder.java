...
import com.mycompany.kafka.governance.interceptors.ConsumerRuleViolation;
...
import com.mycompany.kafka.governance.interceptors.util.JsonDeserializer;
...
public class TopologyBuilder {
    ...
    private static class TopologyTransformerSupplier implements TransformerSupplier<Long, GenericRecord, KeyValue<String, ConsumerRuleViolation>> {
    ...
    private static class TopologyTransformer implements Transformer<Long, GenericRecord, KeyValue<String, ConsumerRuleViolation>> {
